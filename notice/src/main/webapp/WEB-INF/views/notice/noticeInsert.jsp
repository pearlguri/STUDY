		...
		<form id="frm" action="noticeInsert.do" method="post">
			<div>
				<table border="1">
					<tr>
						...
						<td width="150"><input type="date" id="noticeWdate"
							name="noticeWdate" required="required"></td>
					</tr>
					<tr>
						<th>제목</th>
						<td colspan="3"><input type="text" id="noticeTitle"
							name="noticeTitle" size="70" required="required"></td>
					</tr>
					<tr>
						<th>내용</th>
						<td colspan="3"><textarea rows="10" cols="72"
			...
			<div>
				<input type="submit" value="등록">&nbsp;&nbsp; <input
					...
					value="목록" onclick="location.href='notice.noticeList.do'">
			</div>
		</form>
		<div>
